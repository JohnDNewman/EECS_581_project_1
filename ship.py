...
class Ship:
    def __init__(self, coords: list[tuple[int,int]], direction="none"):
        self.coords = coords                                #create coords object based on size of ship
        self._direction = direction                         #create a direction var to help imaging
        self._size = len(self.coords)                       #create a private size attribute for convenience/debugging
        self._hitFlag = []                                  #create _hitFlag and populate list based on size of ship
    ...
    def isHit(self, coords: tuple): 
        for i in range(len(self.coords)):       #for the number of elements in self coords list
    ...
    def in_ship(self, coords: tuple):
        for i in range(len(self.coords)):
            if coords == self.coords[i]:
                return True
        return False
    ...
    #Create function to return direction of ship
